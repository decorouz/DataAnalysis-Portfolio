...
-- compute day from start_at. 
-- merge tables and save result in new permanent table

-- file_name: compile_unclean.sql
WITH
...
--Query result saved in a permanent table : uncleaned_divy_data
